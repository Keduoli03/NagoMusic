      ...
      builder: (context, constraints) {
        ...
        return GestureDetector(
          ...
          onVerticalDragStart: (details) {
            // Only start handling drag, don't jump yet if just a tap
          },
          ...
          child: SizedBox(
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                ...
                final thumbHeight = (viewPort / contentHeight * totalHeight).clamp(40.0, totalHeight);
